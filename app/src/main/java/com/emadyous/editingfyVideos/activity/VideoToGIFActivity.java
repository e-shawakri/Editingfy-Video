...
public class VideoToGIFActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        String sb3 = Environment.getExternalStorageDirectory().getAbsoluteFile() +
                "/" +
        ...
        TextView m = (TextView) findViewById(R.id.Filename);
        ...
        m.setText(new File(this.c).getName());
        d();
...
//        outputPath = Environment.getExternalStorageDirectory().ge
        ...
        outputPath = Environment.getExternalStorageDirectory().getAbsoluteFile() +
                ...
                "Editingfy GIFs" +
                "/" +
                "Editingfy_GIF_" + System.currentTimeMillis() +
                ".gif";

        //-ss 5 -i input.wmv -t 10 -pix_fmt rgb24 output.gif  -filter:v "scale=-1:320"
        ...
        executionId = FFmpeg.executeAsync(comand, new ExecuteCallback() {
            ...
            public void apply(long executionId, int returnCode) {
                if (returnCode == RETURN_CODE_SUCCESS) {
                    ...
                    progBar.setProgress(0);
                    dialog.dismiss();
                    Toast.makeText(VideoToGIFActivity.this, "Execution completed successfully.", Toast.LENGTH_SHORT).show();
...
//                progText.setText(format("%d%%", (int) progressFinal));
    ...
    public Uri addImage(String videoFile) {
        ContentValues values = new ContentValues(3);
        values.put(Media.TITLE, "GIF_" + System.currentTimeMillis());
        values.put(Media.MIME_TYPE, "image/gif");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            values.put(Media.DURATION, videoLength);
        }
        values.put(Media.DESCRIPTION, "Converted To GIF Via Editingfy Video");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            values.put(Media.AUTHOR, "Editingfy Video");
        }
        values.put(Media.DATA, videoFile);
